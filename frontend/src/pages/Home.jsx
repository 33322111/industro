    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      {!isAuthenticated ? (
        <div className="bg-white rounded-xl shadow p-6 text-gray-800 space-y-4 text-lg leading-relaxed">
          <p>
            <strong>Industro</strong> — это современное решение для тех, кто работает в сфере промышленного инжиниринга, монтажа, ремонта и технического обслуживания.
            Платформа помогает соединять заказчиков с квалифицированными подрядчиками, сокращая время поиска и повышая прозрачность процессов.
          </p>
          <p>
            Мы понимаем, насколько сложно бывает найти проверенного специалиста или, наоборот, достойный проект.
            Поэтому наша цель — предоставить надежную среду для публикации резюме и объявлений, чтобы обе стороны могли легко начать сотрудничество.
          </p>
          <p>
            В эпоху цифровизации бизнес-процессов такие решения, как Industro, становятся особенно актуальными: они упрощают коммуникацию,
            экономят ресурсы и способствуют росту доверия в сфере подрядных услуг.
          </p>
          <p>
            Присоединяйтесь к нам — <strong>создайте резюме или опубликуйте задание</strong>, чтобы начать сотрудничество уже сегодня!
          </p>
        </div>
      ) : (
